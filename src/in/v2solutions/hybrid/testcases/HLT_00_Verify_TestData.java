...
public class HLT_00_Verify_TestData extends Constants {
String TCName = "HLT_00_Verify_TestData";
...
public void verify_TestData(Hashtable<String, String> data)throws Exception {
