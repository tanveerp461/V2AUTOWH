...
public class HLT_04_Verify_HostActionsFunctionality extends Constants {
String TCName = "HLT_04_Verify_HostActionsFunctionality";
...
public void verify_HostActionsFunctionality(Hashtable<String, String> data)throws Exception {
