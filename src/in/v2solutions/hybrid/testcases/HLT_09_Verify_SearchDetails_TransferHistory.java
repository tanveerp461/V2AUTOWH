...
public class HLT_09_Verify_SearchDetails_TransferHistory extends Constants {
String TCName = "HLT_09_Verify_SearchDetails_TransferHistory";
...
public void verify_SearchDetails_TransferHistory(Hashtable<String, String> data)throws Exception {
