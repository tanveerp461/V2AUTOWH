...
public class HLT_12_Verify_SearchDetails_ManageTransfers extends Constants {
String TCName = "HLT_12_Verify_SearchDetails_ManageTransfers";
...
public void verify_SearchDetails_ManageTransfers(Hashtable<String, String> data)throws Exception {
