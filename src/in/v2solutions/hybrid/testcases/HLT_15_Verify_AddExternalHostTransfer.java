...
public class HLT_15_Verify_AddExternalHostTransfer extends Constants {
String TCName = "HLT_15_Verify_AddExternalHostTransfer";
...
public void verify_AddExternalHostTransfer(Hashtable<String, String> data)throws Exception {
