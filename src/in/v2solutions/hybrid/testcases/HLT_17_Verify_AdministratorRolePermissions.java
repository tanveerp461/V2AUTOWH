...
public class HLT_17_Verify_AdministratorRolePermissions extends Constants {
String TCName = "HLT_17_Verify_AdministratorRolePermissions";
...
public void verify_AdministratorRolePermissions(Hashtable<String, String> data)throws Exception {
