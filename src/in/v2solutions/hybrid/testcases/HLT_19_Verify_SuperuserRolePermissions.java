...
public class HLT_19_Verify_SuperuserRolePermissions extends Constants {
String TCName = "HLT_19_Verify_SuperuserRolePermissions";
...
public void verify_SuperuserRolePermissions(Hashtable<String, String> data)throws Exception {
