...
public class HLT_21_Verify_ScheduleTransfer extends Constants {
String TCName = "HLT_21_Verify_ScheduleTransfer";
...
public void verify_ScheduleTransfer(Hashtable<String, String> data)throws Exception {
