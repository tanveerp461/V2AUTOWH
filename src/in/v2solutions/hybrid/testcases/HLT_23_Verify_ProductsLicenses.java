...
public class HLT_23_Verify_ProductsLicenses extends Constants {
String TCName = "HLT_23_Verify_ProductsLicenses";
...
public void verify_ProductsLicenses(Hashtable<String, String> data)throws Exception {
