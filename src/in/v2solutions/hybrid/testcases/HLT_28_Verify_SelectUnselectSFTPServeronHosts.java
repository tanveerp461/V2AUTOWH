...
public class HLT_28_Verify_SelectUnselectSFTPServeronHosts extends Constants {
String TCName = "HLT_28_Verify_SelectUnselectSFTPServeronHosts";
...
public void verify_SelectUnselectSFTPServeronHosts(Hashtable<String, String> data)throws Exception {
