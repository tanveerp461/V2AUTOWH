...
public class HLT_29_Verify_SFTPTransfer extends Constants {
String TCName = "HLT_29_Verify_SFTPTransfer";
...
public void verify_SFTPTransfer(Hashtable<String, String> data)throws Exception {
