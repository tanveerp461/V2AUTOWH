...
public class HLT_33_Verify_MetaDatafileForTransfers extends Constants {
String TCName = "HLT_33_Verify_MetaDatafileForTransfers";
...
public void verify_MetaDatafileForTransfers(Hashtable<String, String> data)throws Exception {
