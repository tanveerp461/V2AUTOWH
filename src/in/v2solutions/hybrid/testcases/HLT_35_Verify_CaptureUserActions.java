...
public class HLT_35_Verify_CaptureUserActions extends Constants {
String TCName = "HLT_35_Verify_CaptureUserActions";
...
public void verify_CaptureUserActions(Hashtable<String, String> data)throws Exception {
