...
public class HLT_36_Verify_SystemNotifications extends Constants {
String TCName = "HLT_36_Verify_SystemNotifications";
...
public void verify_SystemNotifications(Hashtable<String, String> data)throws Exception {
