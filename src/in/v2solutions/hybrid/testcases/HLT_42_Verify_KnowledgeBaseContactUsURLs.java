...
public class HLT_42_Verify_KnowledgeBaseContactUsURLs extends Constants {
String TCName = "HLT_42_Verify_KnowledgeBaseContactUsURLs";
...
public void verify_KnowledgeBaseContactUsURLs(Hashtable<String, String> data)throws Exception {
